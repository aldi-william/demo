...
<template>
  ...
  <div class="col-span-12 bg-blue-500 mt-6 sm:my-12 md:my-12 lg:my-12 xl:my-12 2xl:my-12 p-4 sm:p-8 md:p-8 lg:p-8 xl:p-8 2xl:p-8 rounded-lg sm:h-screen w-full sm:w-4/12 md:w-4/12 lg:w-4/12 xl:w-4/12 2xl:w-4/12">
      ...
      <div class="w-full sm:w-40 md:w-40 lg:w-40 xl:w-40 2xl:w-40">
          <button @click="uri('week')" :class="menu === 'week' ? 'bg-white text-blue-500':'text-white bg-blue-500'" class="w-60 mr-4 sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto px-4 py-2 rounded-lg mb-4 text-sm font-bold">7 Hari Terakhir</button>            
      </div>
      <div class="w-full sm:w-40 md:w-40 lg:w-40 xl:w-40 2xl:w-40">
          <button @click="uri('month')" :class="menu === 'menang' ? 'bg-white text-blue-500':'text-white bg-blue-500'" class="w-60 mr-4 sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto px-4 py-2 rounded-lg mb-4 text-sm font-bold">30 Hari Terakhir</button>
      </div>
      <div class="w-full sm:w-40 md:w-40 lg:w-40 xl:w-40 2xl:w-40">
          <button @click="uri('three-month')" :class="menu === 'kalah' ? 'bg-white text-blue-500':'text-white bg-blue-500'" class="w-60 mr-4 sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto px-4 py-2 rounded-lg mb-4 text-sm font-bold">3 Bulan Terakhir</button>
      </div>
      <div class="w-full sm:w-40 md:w-40 lg:w-40 xl:w-40 2xl:w-40">
          <button @click="uri('year')" :class="menu === 'ditolak' ? 'bg-white text-blue-500':'text-white bg-blue-500'" class="w-60 mr-4 sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto px-4 py-2 rounded-lg mb-4 text-sm font-bold">1 Tahun Terakhir</button>
      </div>
    </div>
  </div>
