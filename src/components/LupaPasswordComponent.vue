...
<template>
  <div class="absolute left-0 right-0 top-12 text-center border rounded shadow-xl z-10 bg-white w-4/12 p-8 mx-auto">
    <div v-if="event ==='resetPassword'">
      ...
      <p class="text-red-600 text-left mb-4">Nama yang Anda masukan tidak valid</p>
